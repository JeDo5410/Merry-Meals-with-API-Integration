                        ...
                        <div class="card-body p-0">
                            <div class="row g-0">
                                <div class="col-lg-6">
                                    ...
                                    <div class="progress-indicator">
                                      ...
                                      <div class="progress-step">
                                        ...
                                        <form id="donationForm" action="<?php echo e(route('saveDonationFee')); ?>" method="POST" enctype="multipart/form-data">
                                            <?php echo csrf_field(); ?>
                                ...
                                <div class="col-lg-6 bg-indigo text-white">
                                    <img style="height:100%; width: 100%; object-fit: cover; border-top-right-radius: 15px; border-bottom-right-radius: 15px;" src="<?php echo e(url('/images/donationpage1.png')); ?>" alt="Seniors in need">
                                </div>
                            </div>
                        </div>
                    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Apache\htdocs\Meals_On_Wheels_Project (1)\resources\views/donation/donor.blade.php ENDPATH**/ ?>
                                ...
                                <div class="col-md-4 text-center animate-box" >
                                    <div class="feature-left">
                                        ...
                                        <div class="feature-copy">
                                            ...
                                            <a href="<?php echo e(route('register.form')); ?>?interest=volunteer" class="btn btn-primary">Sign Up Now</a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4 text-center animate-box">
                                    <div class="feature-left">
                                        ...
                                        <div class="feature-copy">
                                            ...
                                            <a href="<?php echo e(route('register.form')); ?>?interest=partner" class="btn btn-primary">Partner With Us</a>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-12 text-center animate-box">
                                ...
                                <div class="faq-item">
                                    ...
                                    <div class="panel">
                                        <p>To request meal delivery, you need to be a registered member or caregiver. Please fill out the <a href="<?php echo e(route('register.form')); ?>?interest=member">registration form</a> on our website to get started.</p>
                                    </div>
                                </div>
                                <div class="faq-item">
                                ...
                                <div class="faq-item">
                                    ...
                                    <div class="panel">
                                        <p>We welcome volunteers to help with meal preparation and delivery. If you're interested in volunteering, please visit our <a href="<?php echo e(route('register.form')); ?>?interest=volunteer">volunteer registration form</a> for more information and to sign up.</p>
                                    </div>
                                </div>
                                <div class="faq-item">
                                ...
                                <div class="faq-item">
                                    ...
                                    <div class="panel">
                                        <p>If you're interested in becoming a food provider partner, please register through our <a href="<?php echo e(route('register.form')); ?>?interest=partner">partner registration form</a> for more information.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Apache\htdocs\Meals_On_Wheels_Project (1)\resources\views/welcome.blade.php ENDPATH**/ ?>